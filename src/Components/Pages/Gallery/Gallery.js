...
const success = [
  {
    ...
    story: `The CEO's role in raising a company's corporate IQ
            ...
            <div>
              <div className="container flex justify-center mx-auto pt-16">
                <div>
                  ...
                  <h1 className="xl:text-4xl text-3xl text-center text-[#1F1F52] font-extrabold pb-4 sm:w-4/6 w-5/6 mx-auto">
              ...
              <div className="w-full pt-20">
                <div className="container mx-auto">
                  <div className="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2  gap-6">
                    {success.map((success) => (
                      <div className="col-span-1  relative mb-20">
